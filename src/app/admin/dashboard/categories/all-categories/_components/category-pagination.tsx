...
export default function CategoryPagination({ totalPages }: { totalPages: number }) {
          ...
          {visiblePages.map((pageNum) => {
            ...
            return (
              <button
                ...
                className={`relative inline-flex items-center px-3.5 sm:px-4 py-2 text-xs sm:text-sm font-semibold border transition-colors cursor-pointer ${
                  isActive
